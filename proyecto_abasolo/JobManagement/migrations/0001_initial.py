    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_empresa', models.CharField(max_length=2, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Maquina',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nro_notaventa_ot', models.CharField(blank=True, max_length=12, null=True)),
                ('item_notaventa', models.IntegerField()),
                ('referencia_notaventa', models.IntegerField(blank=True, null=True)),
                ...
                ('materia_prima', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='Product.materiaprima')),
            ],
        ),
        migrations.CreateModel(
            name='Proceso',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='unidad_medida_materia_prima', to='Product.measurementunit'),
        ),
        migrations.AddField(
            model_name='ordentrabajo',
            name='unidad_medida',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maquina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='JobManagement.maquina')),
                ('proceso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='JobManagement.proceso')),
                ('ruta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='JobManagement.rutaot')),
            ],
            options={
